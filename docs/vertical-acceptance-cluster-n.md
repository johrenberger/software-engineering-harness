# Vertical Acceptance Evidence — Cluster N (HISTORICAL)

> ⚠️ **HISTORICAL TRANSPORT EVIDENCE — NOT CURRENT ACCEPTANCE.**
> This document is preserved as the live transport evidence
> captured during cluster N (2026-07-21, commit `fc8d38d`).
> It is **not** the current MiniMax acceptance target.
>
> **Current acceptance** is documented at
> [`docs/vertical-acceptance.md`](./vertical-acceptance.md)
> (M3 vertical acceptance, cluster M3-4 / M3-5) and the
> capability matrix at
> [`docs/m3-capability-matrix.md`](./m3-capability-matrix.md).
>
> The M2.7 catalog/chat snippets below prove the cluster N
> transport was reachable and that the configured model
> matched the response. They do **not** prove M3 readiness
> and must not be quoted as the current-model acceptance
> gate. See
> `plans/minimax-m3-corrective-processing-instructions.md`
> §"M3-5 smoke verification" for the M3 acceptance
> contract.

> ⚠️ **This PR was DRAFT.** It documents the credentialed live run
...
> These questions were left open at the end of cluster N.
> They have been **superseded** by the M3 corrective
> refinement (2026-07-23, PRs #83-#86) and the M3-5
> Option-(a) closure decision. See
> [`docs/vertical-acceptance.md`](./vertical-acceptance.md)
> for the current acceptance scope. Do not act on these
> questions without first reading the M3 corrective doc.
